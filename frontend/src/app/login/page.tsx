              ...
              <div className="flex justify-center space-x-8">
                ...
                <button
                  onClick={() => {
                    ...
                    alert(JSON.stringify(googleData, null, 2));
                    window.location.href = 'http://localhost:8080/api/v1/auth/google/login?redirect_uri=http://localhost:3000/dashboard';
                  }}
                ...
                <button
                  onClick={() => {
                    ...
                    alert(JSON.stringify(githubData, null, 2));
